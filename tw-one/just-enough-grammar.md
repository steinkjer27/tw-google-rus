...
> В этом фреймворке **объект** должен скопировать все **значения**, которые нужно изменить. **Протоколы сериализации** (protocol buffers) в кодовой базе очень объемные, поэтому **копирование** обходится дорого.

В программировании можно думать о переменных как о существительных внутри программы.
