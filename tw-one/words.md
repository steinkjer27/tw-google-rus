...
Определите все возможные значения неоднозначных местоимений в каждом из текстов ниже:

> Апарна и Фил делят обязанности с Майсамом и Караном, и они дежурят следующими.

Возможные значения местоимения **они**:
- Апарна и Фил
- Майсам и Каран
- Апарна и Фил, Майсам и Каран вместе
- Кто-то из указанных лиц, если «они» использовано в тексте как гендерно-нейтральное местоимение


> Aparna and Phil share responsibilities with Maysam and Karan and they are next on call.
> Любой из указанных лиц в единственном числе как гендерно-нейтральное местоимение
> В русском аналогичную функцию может выполнять местоимение «они», используемое по отношению к одному человеку как местоимение единственного числа, местоимение «оно», чередование «он» и «она». Литературной нормой такое словоупотребление не является.
...
> Вы можете импортировать данные Carambola c помощью файл конфигурации или динамически во время выполнения. Это может быть угрозой безопасности.

Возможные значения местоимения **this**:  
...
[Нажмите на иконку, чтобы увидеть ответ.]()
